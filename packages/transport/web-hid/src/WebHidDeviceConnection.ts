...
} from "@ledgerhq/device-management-kit/src/internal/transport/model/Errors.js";
import { RECONNECT_DEVICE_TIMEOUT } from "@ledgerhq/device-management-kit/src/internal/transport/usb/data/UsbHidConfig.js";
...
export class WebHidDeviceConnection implements DeviceConnection {
  ...
  constructor({
    ...
    this._logger = loggerFactory(WebHidDeviceConnection.name);
    this._device = device;
