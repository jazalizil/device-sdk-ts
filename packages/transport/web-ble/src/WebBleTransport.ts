...
import { BleDeviceConnection } from "./BleDeviceConnection";
import { BleDeviceInfos } from "./BleDeviceInfos";
import { RECONNECT_DEVICE_TIMEOUT } from "./Config";
import { PromptDeviceAccessError } from "./Errors";
...
export class WebBleTransport implements Transport {
  ...
  }): Promise<Either<UnknownDeviceError, void>> {
